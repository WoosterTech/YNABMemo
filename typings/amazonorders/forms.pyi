...
class AuthForm(ABC):
    ...
    """
    def __init__(self, config: AmazonOrdersConfig, selector: Optional[str], error_selector: Optional[str] = ..., critical: bool = ...) -> None:
        ...
...
class SignInForm(AuthForm):
    def __init__(self, config: AmazonOrdersConfig, selector: Optional[str] = ..., solution_attr_key: str = ...) -> None:
        ...
...
class CaptchaForm(AuthForm):
    def __init__(self, config: AmazonOrdersConfig, selector: Optional[str] = ..., error_selector: Optional[str] = ..., solution_attr_key: str = ...) -> None:
        ...
